---
layout: document
url: archie-terms-of-service
---

## Terms of Service for Archie

This Terms of Service Agreement (the "Agreement") is entered into between Caroline Dinh ("Bot Owner") and the user ("User") of the `Archie` Discord bot (the "Bot").
...
*Thank you to [Anshul Chauhan](https://gist.github.com/anshulxyz) for providing the template text for this document.*